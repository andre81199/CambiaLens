...
// node_modules/.pnpm/@storybook+addon-docs@8.0.9/node_modules/@storybook/addon-docs/dist/preview.mjs
...
var parameters = { docs: { renderer: async () => {
  let { DocsRenderer } = await import("./DocsRenderer-K4EAMTCU-4ABJ4KET.js");
